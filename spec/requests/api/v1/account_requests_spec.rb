    ...
    context 'when 403' do
      it_behaves_like 'with authenticated requester' do
        it 'can\'t get account requests' do
          get('/api/v1/account_requests', headers:)
    ...
    context 'when 403' do
      it_behaves_like 'with authenticated requester' do
        it 'can\'t get number of pending account requests' do
          get('/api/v1/account_requests/pending_account_requests_count', headers:)
    ...
    context 'when 404' do
      it_behaves_like 'with authenticated requester' do
        it 'can\'t get an account request' do
          get("/api/v1/account_requests/#{id}", headers:)
    ...
    context 'when 404' do
      it_behaves_like 'with authenticated requester' do
        it 'can\'t delete an account request' do
          delete("/api/v1/account_requests/#{id}", headers:)
