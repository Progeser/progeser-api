    ...
    context 'when 404' do
      it_behaves_like 'with authenticated requester' do
        it 'can\'t get benches' do
          get("/api/v1/greenhouses/#{greenhouse_id}/benches", headers:)
    ...
    context 'when 404' do
      it_behaves_like 'with authenticated requester' do
        it 'can\'t create a bench' do
          post("/api/v1/greenhouses/#{greenhouse_id}/benches", headers:)
    ...
    context 'when 403' do
      it_behaves_like 'with authenticated grower' do
        it 'can\'t delete a bench with ongoing requests' do
          delete("/api/v1/benches/#{id}", headers:)
